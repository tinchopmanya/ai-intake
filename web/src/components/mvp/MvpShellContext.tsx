...
type MvpShellContextValue = {
  ...
  activeConversationMessages: MessageSummary[];
  activeConversationMessagesLoading: boolean;
  savedProcessMomentsCount: number;
  ...
  upsertActiveConversationMessage: (message: MessageSummary) => void;
