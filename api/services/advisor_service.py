...
class AdvisorService:
    ...
    def advise(self, payload: AdvisorRequest) -> AdvisorResponse:
        ...
        try:
            # Design decision: keep a single provider call per advisor session.
    ...
    def _parse_json_response(
        ...
        for item in variants:
            ...
            parsed_variants.append(
                AdvisorVariant(tone=tone_clean, text=text_clean)
            )
    ...
    def _save_output(
        ...
        output = AdvisorOutput(
            ...
            variants_json=json.dumps(
                [variant.model_dump() for variant in response.variants]
            ),
